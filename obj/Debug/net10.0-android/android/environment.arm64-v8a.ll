...
@dso_cache = dso_local local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.11_name, ; name: libLdaNative.so
		ptr null; void* handle
	}, ; 11
	%struct.DSOCacheEntry {
...
@dso_jni_preloads_idx = dso_local local_unnamed_addr constant [8 x i32] [
	...
	i32 31, ; System.Security.Cryptography.Native.Android
	i32 25, ; libxamarin-debug-app-helper.so
	i32 45, ; libxamarin-debug-app-helper
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.hospitaltriageai\00", align 1
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [16 x i8] c"libLdaNative.so\00", align 1
@.DSOCacheEntry.12_name = private unnamed_addr constant [19 x i8] c"libQuestPdfSkia.so\00", align 1
